...
<div class=" d-flex"  style="margin-bottom:10px">
    <form method="get" action='{{route('itemconversionMT.loaditemconversion')}}'>
        {{ csrf_field() }}
...
@include('setting.itemconversion.table')
@endsection
...
<script type="text/javascript">
    ...
    $('#btnsearch').on('click',function(){
      ...
      jQuery.ajax({
          type : "get",
          url : "{{route("searchitemconversion") }}",
          data:{
            itemcode : itemcode,
          },
    ...
    $('#btnrefresh').on('click',function(){
      ...
      jQuery.ajax({
          type : "get",
          url : "{{route("itemconversionMT.index") }}",
          data:{
            itemcode : itemcode,
          },
            beforeSend: function () { // Before we send the request, remove the .hidden class from the spinner and default to inline-block.
