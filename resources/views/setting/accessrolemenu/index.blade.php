    ...
    <div class="modal-content">
      ...
      <form action="{{route('accessrolemenu.update', 'test')}}" method="post">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <h6>
              <center><strong>RFQ</strong></center>
              </h5>
              <hr>
          </div>
          ...
          <div class="form-group">
            <h6>
              <center><strong>RFP</strong></center>
            </h6>
            <hr>
          </div>
          ...
          <div class="form-group">
            <h6>
              <center><strong>Purchase Plan</strong></center>
            </h6>
            <hr>
          </div>
          ...
          <div class="form-group row">
            <label for="level" class="col-md-6 col-form-label text-md-right">{{ __('Shipper') }}</label>
            <div class="col-md-6">
          ...
          <div class="form-group row">
            <label for="level" class="col-md-6 col-form-label text-md-right">{{ __('Supplier Inventory Maintenance')
              }}</label>
            <div class="col-md-6">
          ...
          <div class="form-group row">
            <label for="level" class="col-md-6 col-form-label text-md-right">{{ __('Supplier-Item Maintenance')
              }}</label>
            <div class="col-md-6">
