...
<div class="form-group row">
  ...
  <div class="col-md-2">
    <button class="btn bt-ref col-md-6 col-lg-12 col-form-label" style="object-position: right;" data-toggle="modal"
      data-target="#createModal">Create Relation</button>
  </div>
</div>
@include('setting.supplierinventory.table')
<!-- ===============================search======================================== -->
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('supplierinventoryMT.destroy', 'delete')}}" method="post">
        @method('delete')
        {{ csrf_field() }}
        ...
        <div class="modal-body">
          ...
          <div class="container">
            <div class="row">
              Are you sure you want to delete line:&nbsp; <strong><a name="temp_thist" id="temp_thist"></a></strong>
              &nbsp;?
            </div>
          </div>
...
<div class="modal fade" id="createModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="{{route('supplierinventoryMT.store')}}" method="post">
        @method('post')
        {{ csrf_field() }}
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-md-7">
              <select id="itempart" class="form-control role" name="itempart" style="font-size:16px;" required
                autofocus>
                <option value="" style="font-size:16px !important;"> Select Data </option>
                @foreach($itemMasters as $show)
                <option value='{{$show->id}}' style="font-size:16px !important;">
                  {{$show->iim_item_part.' - '.$show->iim_item_desc}}</option>
                @endforeach
...
<script type="text/javascript">
  $(document).on('click','.pagination a', function(e){
          ...
          $('#btnsearch').on('click',function()
          {
            ...
            ({
                type : "get",
                url : "{{route("searchsupplierinventory") }}",
                data:{
          ...
          $('#btnrefresh').on('click',function(){
            ...
            jQuery.ajax({
              type : "get",
              url : "{{route("supplierinventoryMT.index") }}",
              data:{
                item_search : itemnumber,
              },
              success:function(data){
