...
@section('content')
    <div class="row">
        ...
        <div class="form-group row col-md-12">
            ...
            <div class="col-md-3">
                <input id="nopol" type="text" class="form-control" name="nopol" value="{{$data->sj_nopol}}" autocomplete="off" maxlength="24" autofocus readonly>
            </div>
        </div>
        <div class="form-group row col-md-12">
        ...
        <div class="form-group row col-md-12">
            ...
            <div class="col-md-2">
                <input id="potongdp" type="number" class="form-control" name="potongdp" min="0" step="0.01" value="{{ $data->sj_potongdp }}" autocomplete="off" readonly>
            </div>
        </div>
        <div class="form-group row col-md-12">
