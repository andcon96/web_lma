...
<form action="{{ route('sjconfirm.update',$data->id) }}" id="submit" method="POST">
    ...
    <div class="form-group row col-md-12">
        ...
        <div class="col-md-2">
            <input id="potongdp" type="number" class="form-control" name="potongdp" min="0" step="0.01" value="{{ old('potongdp') ? old('potongdp') : 0 }}" autocomplete="off">
        </div>
    </div>
    <div class="form-group row col-md-12">
    ...
    <div class="form-group row">
        <div class="col-lg-2 col-md-2 col-sm-12 py-2 ml-auto" style="margin-top:90px;">
