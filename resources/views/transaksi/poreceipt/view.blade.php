...
<form method="post" action="{{route('submitReceipt')}}" id='submit'>
  ...
  <div class="row">
    <div class="col-lg-2 col-md-2 col-sm-12 py-2 ml-auto">
      <a id="back_btn" class="btn btn-danger" style="width: 100%;" href="{{route('searchPO',['ponbr'=>$receiptdetail->first()->po_nbr,'kontrak'=>$receiptdetail->first()->po_contract,'supp'=>$receiptdetail->first()->po_cust])}}">Cancel</a>
    </div>
