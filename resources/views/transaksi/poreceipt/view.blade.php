...
<form method="post" action="{{route('submitReceipt')}}" id='submit'>
  <div class="row mb-3">
    ...
    <div class="col-md-2">
      <input id="po_nbr" type="text" class="form-control" name="po_nbr" value="{{$receiptdetail[0]->po_nbr}}" readonly>
    </div>
    <label for="po_kontrak" class="col-form-label col-md-2" style="margin-left:25px">{{ __('PO Contract') }}</label>
    <div class="col-md-2">
      <input id="po_kontrak" type="text" class="form-control" name="po_kontrak" value="{{$receiptdetail[0]->po_contract}}" readonly>
    </div>
  </div>
  <div class="row mb-3">
    <label for="supp" class="col-form-label col-md-2" style="margin-left:25px">{{ __('Supplier') }}</label>
    <div class="col-md-4">
      <input id="supp" type="text" class="form-control" name="supp" value="{{$receiptdetail[0]->po_cust}} -- {{$receiptdetail[0]->po_custname}}" readonly>
      <input type="hidden" name="supphidden" value="{{$receiptdetail[0]->po_cust}}"/>
    </div>
  </div>
