...
<form method="post" action="{{route('sendMailApproval')}}" id='submit'>
  ...
  <a class="btn btn-danger float-right" href="{{url()->previous()}}" style="margin-top:10px; margin-left:5px;">Cancel</a>
  <input type="submit" name="submit" id='s_btnconf' value='Submit' class="btn btn-info float-right"
