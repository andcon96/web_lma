    ...
    <table class="table table-bordered" style="margin-bottom: 225px;" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input type="number" name="qtyinput[]" style="width: 100px !important;" class="form-control" max="{{$show->sod_qty_ord - $show->sod_qty_ship - $show->sod_qty_ongoing}}" step="0.01" value="0" required {{$show->sod_qty_ord <= $show->sod_qty_ship + $show->sod_qty_ongoing ? 'disabled':''}} /></td>
                <td>
                    <select name="partloc[]" class="form-control selectpicker" data-width="320px" data-style="btn-custom" data-size='4' data-dropup-auto="false" data-live-search="true">
                        @foreach ($loc as $locs)
